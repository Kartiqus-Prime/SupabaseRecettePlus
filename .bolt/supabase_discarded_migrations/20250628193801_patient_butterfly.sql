-- Mettre à jour les URLs d'images dans la table videos pour utiliser des images valides
UPDATE videos 
SET thumbnail = CASE 
  WHEN thumbnail LIKE '%8629141%' THEN 'https://images.pexels.com/photos/1640777/pexels-photo-1640777.jpeg?auto=compress&cs=tinysrgb&w=800'
  ELSE thumbnail
END
